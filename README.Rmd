...
La version de développement peut être installée depuis [GitHub](https://github.com/patrickaubert/asdep) :
...
Le package contient une application Shiny illustrant son utilisation. Pour la lancer :
